...
@EnableKafka
@Configuration
public class KafkaAuctionConsumerConfig {
    ...
    public ConsumerFactory<String, Auction> auctionConsumerFactory() {
        JsonDeserializer<Auction> deserializer = new JsonDeserializer<>(Auction.class);
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Auction>> auctionKafkaListenerContainerFactory() {
